...
public:
  ...
  bool upgradeUnit(int upgradeType);

  void stageStart();
  void stageUpdate(float elapsedTime);
  void stageEnd(bool bStageClear);

  void attackEnemy(AnimateObject* my, AnimateObject* enemy);
...
private:
  ...
  bool		mCountDownStart{ false };
  float		mStartTime{ 0.0f };
  bool		mIsGameWin{ false };
